...
plot_global_otu <- function(res_sub, ylab1="", ylab2="", ylab3="") {
    ...
    plot(NA, main="", xlab="", ylab=ylab1, ylim=c(0.1, 0.65), xlim=c(beta_range1[1]-d1, beta_range1[2]+d1), bty="n")
    box(lwd=1.5)
    ...
    d1=(beta_range1[2]-beta_range1[1])*0.03
    plot(NA, main="", xlab="", ylab=ylab2, ylim=c(0, 0.55), xlim=c(beta_range1[1]-d1, beta_range1[2]+d1), bty="n")
    box(lwd=1.5)
