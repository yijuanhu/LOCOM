...
plot_global_otu <- function(res_sub, ylab1="", ylab2="", ylab3="") {
    ...
    plot(NA, main="", xlab="", ylab=ylab1, ylim=c(0.05, 0.7), xlim=c(beta_range1[1]-d1, beta_range1[2]+d1), bty="n")
    box(lwd=1.5)
    ...
    if (causal_type==1) legend(x=beta_range1[1]-d1, y=1, 
                               c("New-omni", "New-equal", "New-count", "Com-count", "Com-p-C", "Com-p-HM", "16S", "SMS"), 
